...
# partial_data = np.load("noisy_data_q34_100.npy")
...
args1 = (N, N_buffer, N_src, k, f, partial_data, model, device, True, "adjoint", regularization)
args2 = (N, N_buffer, N_src, k, f, partial_data, model, device, False, "adjoint", regularization)
...
plt.tight_layout()
# plt.savefig('./figures/inv.png',bbox_inches='tight', pad_inches=0)

plt.figure(3, figsize=(4, 3), dpi=200)
